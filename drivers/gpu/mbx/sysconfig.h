...
#define VS_PRODUCT_NAME	"OMAP 24xx"

#if !defined(DISABLE_TA)

#define MBX_REG_SYS_PHYS_BASE				IO_ADDRESS(0x3B000000)
#define MBX_REG_RANGE					0x00004000

#define MBX_SP_3D_SYS_PHYS_BASE				IO_ADDRESS(0x3B008000)
#define MBX_SP_3D_RANGE					0x00002000

#define MBX_SP_2D_SYS_PHYS_BASE				IO_ADDRESS(0x3B00A000)
#define MBX_SP_2D_RANGE					0x00002000

#define MBX_SP_TA_CTRL_SYS_PHYS_BASE			IO_ADDRESS(0x3B00C000)
...
#define MBX_SP_3D_SYS_PHYS_BASE				IO_ADDRESS(0x3B002000)
#define MBX_SP_3D_RANGE					0x00001000

#define MBX_SP_2D_SYS_PHYS_BASE				IO_ADDRESS(0x3B00A000)
#define MBX_SP_2D_RANGE					0x00002000

#define MBX_SP_TA_CTRL_SYS_PHYS_BASE			IO_ADDRESS(0x3B003000)
